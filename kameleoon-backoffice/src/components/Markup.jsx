...
const Navigation = ({ onSearch, numTests, showNavigationInfo }) => (
    ...
    <div className="navigation__search">
      <div className="searchbar">
        <div className="searchbar__field">
          ...
          <button className="searchbar__field-info" type="button">{numTests} tests</button>
        </div>
      </div>
    </div>
    {showNavigationInfo && (
  ...
  return (
    <div className="table">
      <div className="table__wrapper">
        <Navigation onSearch={handleSearch} numTests={numTests} showNavigationInfo={showNavigationInfo} />
